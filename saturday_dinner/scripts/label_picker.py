...
사용법:
    python -m saturday_dinner.scripts.label_picker [OPTIONS]
    또는
    saturday-label-picker [OPTIONS]

예시:
    python -m saturday_dinner.scripts.label_picker --input labels.csv --output spec_labels.json --chapter chapter_01
"""
...
예시:
  ...
  python -m saturday_dinner.scripts.label_picker --input labels.csv --output spec_labels.json
  python -m saturday_dinner.scripts.label_picker --input data/labels.csv --output specs/spec_new.json --chapter chapter_100
        """
    )
